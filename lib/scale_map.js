...
export class ScaleMap {
    constructor(scaleSongs) {
            this.scales = new Scales();
            this.scaleSongs = scaleSongs;
            this.key = 'C';
            this.chordOctave = 4;
            this.scaleOctave = -1;
    ...
    titles(){
        return Object.keys(this.scaleSongs);
    }

    select(title){
        this.setBlackScaleId(this.scaleSongs[title].blackScaleId);
        this.setWhiteScaleId(this.scaleSongs[title].whiteScaleId);
    }

    getWhiteScaleSize(){
        return this.whiteSet.length;
    }
    ...
    setChordOctave(octave){
        this.chordOctave = octave;
        this.update();
    }
